...
class RepairCostScreen extends StatefulWidget {
  const RepairCostScreen({super.key});
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Estimated repair costs for ${_filteredDtcCodes.length} DTC codes',
                      style: TextStyle(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Cost estimate not available for this DTC code. Search on Google for pricing information.',
                    style: TextStyle(
                      color: Colors.white70,
                      fontSize: 12,
                    ),
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (costRange != null || severity != null || category != null) ...[
                        const SizedBox(height: 16),
                        const Divider(height: 1, color: Colors.white24),
                        const SizedBox(height: 16),
                        if (costRange != null)
                          Container(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.attach_money, size: 32, color: Colors.orangeAccent),
                                const SizedBox(width: 12),
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
