...
class VehicleListContent extends StatefulWidget {
  final bool showAppBar;

  const VehicleListContent({super.key, this.showAppBar = false});

  @override
  State<VehicleListContent> createState() => _VehicleListContentState();
}

class _VehicleListContentState extends State<VehicleListContent> {
  @override
  void initState() {
    super.initState();
    VehicleService.init();
  ...
  Future<void> _deleteVehicle(Vehicle vehicle) async {
    ...
    if (confirmed == true) {
      ...
      // Also delete maintenance items for this vehicle
      await MaintenanceService.deleteByVehicle(vehicle.id);
      if (mounted) {
